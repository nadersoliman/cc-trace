...
| Tool | `tool.input` | string | Hook payload `tool_input` (JSON-stringified, truncated to 4096) |
| Tool | `tool.response` | string | Hook payload `tool_response` (JSON-stringified, truncated to 4096) |
